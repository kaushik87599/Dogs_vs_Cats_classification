...
class custom_attention_cnn(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.residual = nn.Sequential(
            nn.Dropout(p=0.5),
            nn.Flatten(),
            nn.Linear(in_features=16384, out_features=2)
        )
        log_in('Finished defining custom_attention_cnn')
...
class custom_basic_cnn(torch.nn.Module):
    ...
    def __init__(self):
        ...
        log_in('Finished defining custom_basic_cnn')
